...
import com.duanluo.search.similarity.SubjectSimilarity;
import com.google.protobuf.Message;

public class SubjectSearcher<R extends BasicIndexReader, MW, M> extends BasicSearcher<R,MW, M>{
	
	
	
	
	SubjectSearcher(SearcherConfig<R,MW, M> config, StreamDataProvider<MW> dataProvider) {
