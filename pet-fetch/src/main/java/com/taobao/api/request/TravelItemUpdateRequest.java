...
import com.taobao.api.response.TravelItemUpdateResponse;
 ...
 */
public class TravelItemUpdateRequest implements TaobaoUploadRequest<TravelItemUpdateResponse> {
...
设置为false，那么该商品为非铁定出游商品。
	...
	* 商品标题。不超过60个字节或者30个汉字
	...
	public Class<TravelItemUpdateResponse> getResponseClass() {
		return TravelItemUpdateResponse.class;
	}
