...
public abstract class TaobaoUtils {
	...
	public static String signTopRequest(RequestParametersHolder requestHolder, String secret) throws IOException {
		...
		return signTopRequest(sortedParams, secret);
	}

	public static String signTopRequest(Map<String, String> parameters, String secret) throws IOException {
		// 第一步：检查参数是否已经排序
		...
		// 第二步：把所有参数名和参数值串在一起
		Set<Entry<String, String>> paramSet = parameters.entrySet();
