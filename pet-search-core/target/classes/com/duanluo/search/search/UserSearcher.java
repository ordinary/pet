...
import com.duanluo.search.similarity.UserSimilarity;
import com.google.protobuf.Message;

public class UserSearcher<R extends BasicIndexReader, MW, M> extends BasicSearcher<R,MW, M>{
	
	UserSearcher(SearcherConfig<R,MW, M> config, StreamDataProvider<MW> dataProvider) {
	...
	public Message search(Query query, Collector collector, int begin, int count) {
		...
		try {
			...
			searcher.setSimilarity(new UserSimilarity());
